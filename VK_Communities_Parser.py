...
group_domain = 'your_group_domein'  # Replace with the actual group ID+
...
filename = f'{group_domain}draft1.txt'
...
# Проверка на успешность получения идентификатора группы
if group_id is not None:
    print(f"Group ID for '{group_domain}': {group_id}")
else:
